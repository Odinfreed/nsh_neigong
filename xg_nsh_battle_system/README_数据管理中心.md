...
**帮会对比分析优化**：
- 📊 职业分布图表改为折线统计图（tension: 0，直线连接）
- 📊 其他图表改为直角样式（borderRadius: 0）
- 🎨 颜色主题同步：帮会1红色(#EF4444)、帮会2蓝色(#3B82F6)
- ✏️ 双击编辑帮会名称功能（双击标签即可修改）
- 🔄 排行榜帮会名称同步修复（动态获取当前帮会名）
- 🔍 个人分析添加帮会筛选（全部/帮会1/帮会2）
- 👤 个人分析显示隶属帮会（玩家信息和排名卡片）
